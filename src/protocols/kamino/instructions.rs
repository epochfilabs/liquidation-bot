...
/// Derive the lending market authority PDA: `[b"lma", lending_market]`.
...
/// Data layout: `[disc(8)] [liquidity_amount(u64 LE)]`
...
/// Data layout: `[disc(8)] [liquidity_amount(u64 LE)] [borrow_instruction_index(u8)]`
...
/// Data layout: `[disc(8)] [liquidity_amount(u64)] [min_received(u64)] [max_ltv_override(u64)]`
#[allow(clippy::too_many_arguments)]
...
mod tests {
    ...
    fn liquidate_v1_discriminator() {
        let disc =
            anchor_discriminator("global:liquidate_obligation_and_redeem_reserve_collateral");
    ...
    fn lending_market_authority_derivation() {
        let market: Pubkey = "7u3HeHxYDLhnCoErrtycNokbQYbWGzLs6JSDqGAv5PfF"
            .parse()
            .unwrap();
        let (authority, _bump) = derive_lending_market_authority(&market, &KLEND_PROGRAM_ID);
